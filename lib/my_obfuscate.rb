...
class MyObfuscate
  attr_accessor :config, :globally_kept_columns, :fail_on_unspecified_columns, :database_type, :ignore_depricated_warnings
  ...
  def ignore_depricated_warnings?
    @ignore_depricated_warnings
  end
